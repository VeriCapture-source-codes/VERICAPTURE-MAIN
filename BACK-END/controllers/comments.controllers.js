...
export const createComment = async (req, res, next) => {
  ...
  if (!userId || !postId) {
    return next(
      new ApiError(
        403,
        "You are not authorized. Please Login and click on the post to comment"
      )
    );
  }
...
export const updateComment = async (req, res, next) => {
  ...
  if (!userId || !commentId) {
    return next(
      new ApiError(
        403,
        "You are not authorized. Please Login and click on the comment you want to update"
      )
    );
  }
...
export const commentLikes = async (req, res, next) => {
  ...
  if (!userId || !commentId) {
    return next(
      new ApiError(
        403,
        "You are not authorized. Please Login and go the comment you want to like"
      )
    );
  }
